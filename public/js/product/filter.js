document.addEventListener('DOMContentLoaded', function () {
    ...
    // Dropdown for rating
    const ratingDropdownButton = document.getElementById('ratingDropdownButton');
    ...
    const stockQuantityDropdownButton = document.getElementById('stockQuantityDropdownButton');
    const stockQuantityDropdown = document.getElementById('stockQuantityDropdown');
