                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST"
                            ...
                            <input name="price" value="{{ $viewData['product']->getPrice() }}" type="text"
                                class="form-control mb-2 border border-gray-300 rounded-md p-2 w-full focus:ring-1 focus:ring-brightPink focus:border-pbrightPink"
                            ...
                            <button type="submit"
                                class="bg-brightPink text-white px-4 py-2 rounded-md hover:bg-black">{{ __('product.edit') }}</button>
                        </form>
                    </div>
                </div>
            </div>
