    ...
    <div class="flex justify-center">
        <div class="relative max-h-full w-full max-w-2xl p-4">
            <div class="relative rounded-lg bg-white shadow">
                ...
                <form method="POST" action="{{ route('colorimetry.save') }}" class="p-4 md:p-5">
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="mb-4">
                        ...
                        <select name="skinTone"
                            ...
                            <option value="" disabled selected>{{ __("colorimetry.skinTone_select") }}</option>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="skinUndertone"
                                class="focus:border-primary-600 focus:ring-primary-600 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900">
                            <option value="" disabled selected>{{ __("colorimetry.skinUndertone_select") }}</option>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="hairColor"
                                class="focus:border-primary-600 focus:ring-primary-600 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900">
                            <option value="" disabled selected>{{ __("colorimetry.hairColor_select") }}</option>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="eyeColor"
                                class="focus:border-primary-600 focus:ring-primary-600 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900">
                            <option value="" disabled selected>{{ __("colorimetry.eyeColor_select") }}</option>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="specificNeeds[]" multiple size="4" class="focus:border-primary-600 focus:ring-primary-600 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900">
                            <option value="{{ __("colorimetry.sensitive_skin") }}">{{ __("colorimetry.sensitive_skin") }}</option>
                            <option value="{{ __("colorimetry.acne") }}">{{ __("colorimetry.acne") }}</option>
                            <option value="{{ __("colorimetry.dry") }}">{{ __("colorimetry.dry") }}</option>
                            <option value="{{ __("colorimetry.oil") }}">{{ __("colorimetry.oil") }}</option>
                        </select>
                    </div>
