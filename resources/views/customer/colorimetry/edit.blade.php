          ...
          <div class="col-span-2 mb-4 mt-4">
            ...
            >
              <option
                ...
                {{ in_array("Sensitive Skin", $viewData["selectedNeeds"]) ? "selected" : "" }}
              >
                {{ __("colorimetry.sensitive_skin") }}
              </option>
              <option
                value="{{ __("colorimetry.acne") }}"
                {{ in_array("Acne-Prone", $viewData["selectedNeeds"]) ? "selected" : "" }}
              >
                {{ __("colorimetry.acne") }}
              </option>
              <option
                value="{{ __("colorimetry.dry") }}"
                {{ in_array("Dry Skin", $viewData["selectedNeeds"]) ? "selected" : "" }}
              >
                {{ __("colorimetry.dry") }}
              </option>
              <option
                value="{{ __("colorimetry.oil") }}"
                {{ in_array("Oily Skin", $viewData["selectedNeeds"]) ? "selected" : "" }}
              >
                {{ __("colorimetry.oil") }}
              </option>
            </select>
