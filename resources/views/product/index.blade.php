...
<div class="container mx-auto px-4 py-4 w-4/5">
  <nav class="text-gray-500 mb-4">
    <ol class="list-reset flex">
      <li><a href="#" class="text-gray-600 hover:text-gray-900">{{ __('messages.home') }}</a></li>
      <li><span class="mx-2">/</span></li>
      <li><a href="#" class="text-gray-600 hover:text-gray-900">{{ __('messages.makeup') }}</a></li>
      <li><span class="mx-2">/</span></li>
      <li class="text-gray-700">{{ __('messages.category') }}</li>
    </ol>
  </nav>

  <h1 class="text-3xl font-bold text-gray-800 mb-4">{{ __('messages.products') }}</h1>

  <div class="mb-6 flex space-x-4">
    <button class="px-4 py-2 rounded-full bg-gray-200 text-gray-700 hover:bg-gray-300">{{ __('messages.all') }}</button>
  </div>
